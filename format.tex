...
\def\makecover{
  ...
  \ifx\temp\preferlanguage
    ...
    \zihao{-2}\vspace*{10mm}
		\renewcommand{\CJKglue}{\hskip 2pt plus 0.08\baselineskip}
    \centerline{\zihao{2}\textbf{SUSTech}}
		
		\vspace{10mm}
		\centerline{\zihao{2}\textbf{Thesis Proposal of Master Candidates}}
...
\vspace{30pt}
	...
	\renewcommand{\arraystretch}{1.3}
    \begin{tabular}{l@{}l}
    \textbf{School (Department)}   & \rule[-4pt]{250pt}{1pt}\hspace{-352pt}\centerline{\textbf\@affil}\\
    ...
    \@assosupervisor
	\@cosupervisor
    \textbf{Graduate}      & \rule[-4pt]{250pt}{1pt}\hspace{-352pt}\centerline{\textbf\@author}\\
    \textbf{Student Number}  & \rule[-4pt]{250pt}{1pt}\hspace{-352pt}\centerline{\textbf\@stuno}\\
    \textbf{Defense Date} & \rule[-4pt]{250pt}{1pt}\hspace{-352pt}\centerline{\textbf\@date}\\
    \end{tabular}
