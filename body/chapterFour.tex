...
\begin{figure}[htbp]
\centering
\includegraphics[width = 0.8\textwidth]{figure4_3.eps}
...
另一方面，当混合载波通信系统中存在频偏影响时，发射信号受到频偏的影响在接收端的基带信号表示形式如下：
\begin{equation}
...
\begin{figure}[htbp]
\centering
\includegraphics[width = 0.8\textwidth]{berwithfreerror.eps}
