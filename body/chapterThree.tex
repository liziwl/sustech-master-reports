...
\subfigure{\subfigure[~$\alpha$~= 0]{\includegraphics[width=0.4\textwidth]{xingzuo0.eps}}}
\subfigure{\label{xingzuo2}}\addtocounter{subfigure}{-2}
\subfigure{\subfigure[~$\alpha$~= 0.1]{\includegraphics[width=0.4\textwidth]{xingzuo01.eps}}}
\subfigure{\label{xingzuo3}}\addtocounter{subfigure}{-2}
\subfigure{\subfigure[~$\alpha$~= 0.25]{\includegraphics[width=0.4\textwidth]{xingzuo025.eps}}}
\subfigure{\label{xingzuo4}}\addtocounter{subfigure}{-2}
\subfigure{\subfigure[~$\alpha$~= 1]{\includegraphics[width=0.4\textwidth]{xingzuo1.eps}}}
